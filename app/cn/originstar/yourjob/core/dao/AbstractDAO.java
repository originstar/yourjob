package cn.originstar.yourjob.core.dao;
...
public abstract class AbstractDAO<T, ID extends Serializable> extends GenericDAOImpl<T, ID> implements DAO<T, ID> {
    ...
    protected MetadataUtil getMetadataUtil() {
        return HibernateMetadataUtil.getInstanceForEntityManagerFactory((org.hibernate.ejb.HibernateEntityManagerFactory) JPA.em().getEntityManagerFactory());
    }
